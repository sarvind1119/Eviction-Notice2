...
I hope this letter finds you well. I am writing to officially notify you that your tenancy at [Tenant’s Address] {tenant_address} is terminated by the terms of our lease agreement dated [Date of Lease Agreement] {date_of_lease}.

The grounds for eviction are [Specify grounds, e.g., non-payment of rent, breach of terms, etc.] {grounds_for_eviction}. As per Section X of the Rent Control Act [mention relevant Act], these grounds warrant termination of the tenancy.

Notice Period: You are hereby given [X] {notice_period} days’ notice to vacate the premises, as required by Section Y of the Rent Control Act. The notice period starts from the date of receipt of this letter.

Rent Arrears: Please be advised that the outstanding rent amount of [Specify amount] {outstanding_rent} for the period [Specify period] {rent_period} is due and must be settled before the end of the notice period to avoid further legal action.

Property Inspection: Prior to vacating the premises, a joint inspection of the property will be conducted on [Specify Date and Time] {inspection_date_time} to assess any damages. Your presence is requested during this inspection.
...
Should you have any concerns or queries regarding this notice, please feel free to contact me at [Your Phone Number] {phone} or [Your Email Address] {email}.
